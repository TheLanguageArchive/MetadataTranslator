...
<xsl:stylesheet xmlns="http://www.mpi.nl/IMDI/Schema/IMDI" 
    ...
    <xsl:template name="DBDSESSION2IMDISESSION">
        <METATRANSCRIPT xmlns="http://www.mpi.nl/IMDI/Schema/IMDI"
            ...
            <xsl:attribute name="Originator">
                <xsl:value-of select="tla:create-originator('DBDSESSION2IMDISESSION.xslt', //Header/MdSelfLink)" />
            </xsl:attribute>
    ...
    <xsl:template match="DBD/Session" mode="DBDSESSION2IMDISESSION">
        ...
        <Session>
            ...
            <MDGroup>
                ...
                <Actors>
                    <xsl:apply-templates select="Actors/descriptions" mode="DBDSESSION2IMDISESSION"/> 
    ...
    <xsl:template match="Access" mode="DBDSESSION2IMDISESSION">
        <Access>
    ...
    <xsl:template match="Contact" mode="DBDSESSION2IMDISESSION">
    ...
    <xsl:template match="descriptions" mode="DBDSESSION2IMDISESSION">
    ...
    <xsl:template match="MediaFile" mode="DBDSESSION2IMDISESSION">        
        ...
        <MediaFile>
            ...
            <xsl:apply-templates select="Access" mode="DBDSESSION2IMDISESSION" />  
            <xsl:apply-templates select="descriptions" mode="DBDSESSION2IMDISESSION"/>
            <Keys>
                <xsl:apply-templates select="Keys" mode="DBDSESSION2IMDISESSION"/>
            </Keys>
    ...
    <xsl:template match="Keys" mode="DBDSESSION2IMDISESSION">
        <xsl:choose>
