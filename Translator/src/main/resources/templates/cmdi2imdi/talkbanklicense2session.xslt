...
<xsl:stylesheet xmlns="http://www.mpi.nl/IMDI/Schema/IMDI" 
    ...
    <xsl:template name="TALKBANKLICENSE2IMDI">
        <METATRANSCRIPT xmlns="http://www.mpi.nl/IMDI/Schema/IMDI"
            ...
            <xsl:attribute name="Originator">
                <xsl:value-of select="tla:create-originator('TALKBANKLICENSE2IMDI.xslt', //Header/MdSelfLink)" />
            </xsl:attribute>
            <xsl:attribute name="Date">
                <xsl:value-of select="//Header/MdCreationDate" />
            </xsl:attribute>
            <xsl:apply-templates select="//talkbank-license-session/Session" mode="TALKBANK2IMDI"/>
        </METATRANSCRIPT>
    </xsl:template>
    
    <xsl:template match="talkbank-license-session/Session" mode="TALKBANK2IMDI">
        <History>
            <xsl:if test="normalize-space(child::History)!=''">
                    <xsl:value-of select="child::History"/>
                    <xsl:text> </xsl:text>
            </xsl:if>                   
            <xsl:text> NAME:TALKBANKLICENSE2IMDI.xslt DATE:</xsl:text>
        ...
        <Session>
            ...
            <MDGroup>
                <xsl:apply-templates select="MDGroup/Location" mode="COMMONTLA2IMDISESSION"/>
                <xsl:apply-templates select="MDGroup/Project" mode="TALKBANK2IMDI"/>
                <Keys>
                    <xsl:apply-templates select="MDGroup/Keys" mode="COMMONTLA2IMDISESSION"/>
                </Keys>
                <xsl:apply-templates select="MDGroup/Content" mode="TALKBANK2IMDI"/>
                <Actors>
                    <xsl:apply-templates select="MDGroup/Actors/descriptions" mode="COMMONTLA2IMDISESSION"/> 
                    <xsl:apply-templates select="MDGroup/Actors/Actor" mode="TALKBANK2IMDI"/>                
                </Actors>
            </MDGroup>
    ...
    <xsl:template match="Project" mode="TALKBANK2IMDI">
        <Project>
    ...
    <xsl:template match="Content" mode="TALKBANK2IMDI">
        <Content>
            ...
            <Languages>
                ...
                <xsl:apply-templates select="//Content_Language" mode="TALKBANK2IMDI"/>
            </Languages>
            <Keys>
    ...
    <xsl:template match="Actor" mode="TALKBANK2IMDI">
        <Actor>
            <xsl:if test="@ref">
            ...
            <Languages>
                ...
                <xsl:apply-templates select="descendant::Actor_Language" mode="TALKBANK2IMDI"/>
            </Languages>
    ...
    <xsl:template match="Content_Language" mode="TALKBANK2IMDI">
        <Language>
            <xsl:if test="@ref">
                <xsl:attribute name="ResourceRef" select="@ref" />
            </xsl:if>
    ...
    <xsl:template match="Actor_Language" mode="TALKBANK2IMDI">
        <Language>
            <xsl:if test="@ref">
                <xsl:attribute name="ResourceRef" select="@ref" />
            </xsl:if>
